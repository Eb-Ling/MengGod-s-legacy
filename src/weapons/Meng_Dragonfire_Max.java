 ...
 */
public class Meng_Dragonfire_Max extends BaseCombatLayeredRenderingPlugin implements OnFireEffectPlugin,
        OnHitEffectPlugin,
        EveryFrameWeaponEffectPlugin {

    protected List<Meng_Dragonfire_Max> trails;
    ...
    public Meng_Dragonfire_Max() {
    }

    public Meng_Dragonfire_Max(DamagingProjectileAPI proj, DamagingProjectileAPI prev) {
        this.proj = proj;
        this.prev = prev;
    ...
    public void advance(float amount, CombatEngineAPI engine, WeaponAPI weapon) {
        ...
        Iterator<Meng_Dragonfire_Max> iter = trails.iterator();
        while (iter.hasNext()) {
        ...
        if (weapon.getShip() != null) {
            ...
            for (Meng_Dragonfire_Max curr : trails) {
                if (curr.proj != null) {
        ...
        for (int i = 0; i < numIter; i++) {
            for (Meng_Dragonfire_Max trail : trails) {
...
//								   rampUp, dur, inverted);
    ...
    public void onFire(DamagingProjectileAPI projectile, WeaponAPI weapon, CombatEngineAPI engine) {
        ...
        Meng_Dragonfire_Max trail = new Meng_Dragonfire_Max(projectile, prev);
        ...
        if (trails == null) {
            trails = new ArrayList<Meng_Dragonfire_Max>();
        }
        trails.add(0, trail);
    }
    ...
    public static class ParticleData {
        ...
        public ParticleData(DamagingProjectileAPI proj) {
            ...
            scaleIncreaseRate = 2f / maxDur;//设定与飞行时间挂钩的特效扩张速度
            scale = 1f;
//			scale = 0.1f;
