...
public class Meng_DragonLbiucover implements EveryFrameWeaponEffectPlugin {
    ...
    public void advance(float amount, CombatEngineAPI engine, WeaponAPI weapon) {
        ...
        if (light > lastlight) {
            ...
            fire = true;
            if (step >= 8) step = 8;
            SpriteAPI sprite = Global.getSettings().getSprite("Meng", "Meng_DragonLcover0" + step);
            ...
            timer += amount;
            fire = false;
            SpriteAPI sprite = Global.getSettings().getSprite("Meng", "Meng_DragonLcover08");
            MagicRenderPlugin.addSingleframe(sprite, weapon.getLocation(), CombatEngineLayers.ABOVE_SHIPS_LAYER);
